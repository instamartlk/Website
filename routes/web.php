...
/*
  ...
  |
 */
Route::get('pay-online', 'App\Http\Controllers\CheckoutController@onlinePayment');
Route::post('pay-response', 'App\Http\Controllers\Payment\WebxpayController@webxpayCallback');
...
Route::get('/emailverification/{email}', [VerificationController::class, 'selleremailverification']);
...
Route::group(['middleware' => ['customer', 'verified', 'unbanned']], function() {
    ...
    Route::group(['prefix' => 'checkout'], function() {
        Route::controller(CheckoutController::class)->group(function () {
            ...
            Route::post('/session-pay', 'session_pay')->name('checkout.session_pay');
...
Route::get('session-pay-response/{id}', 'App\Http\Controllers\CheckoutController@get3dsResponse');
Route::post('get-payment-status', 'App\Http\Controllers\CheckoutController@getPaymentStatus');
