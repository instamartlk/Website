        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="bank_routing_no" value="{{ $user->shop->bank_routing_no }}" id="bank_routing_no" lang="en" class="form-control mb-3" placeholder="{{ translate('Branch Name')}}">
                        @error('Branch Name No')
                        <small class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                </div>
